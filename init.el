...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(list-face ((t (:background "cyan" :foreground "black" :weight bold))))
 '(loud-face ((t (:background "orange" :foreground "black"))))
 '(scroll-bar ((t (:background "dim gray" :foreground "black"))))
 '(zoinks-face ((t (:background "greenyellow" :foreground "black")))))
...
(defun timestamp ()
  ...
  (insert (format-time-string "%-m/%-d/%Y %H:%M:%S %Z")))
